    ...
    <div class="site-footer">
        <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="col-12 col-md-12 col-lg-4">
                        <div class="site-footer__widget footer-newsletter">
                            <h5 class="footer-newsletter__title">Ikuti Kami</h5>
                            ...
                            <ul class="footer-newsletter__social-links">
                                <li class="footer-newsletter__social-link footer-newsletter__social-link--facebook">
                                    <a href="https://www.facebook.com/ixxcubbhy.agunk" target="_blank"><i class="fab fa-facebook-f"></i></a></li>
                                ...
                                <li class="footer-newsletter__social-link footer-newsletter__social-link--youtube">
                                    <a href="https://www.youtube.com/channel/UCeqehej75-tNmvqn4wkPSIA" target="_blank"><i class="fab fa-youtube"></i></a></li>
            ...
            <div class="site-footer__bottom">
                <div class="site-footer__copyright">&copy; <?= date('Y') ?> Kelompok 8</div>
